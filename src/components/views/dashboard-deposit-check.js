    ...
    const handleaddamount = () => {
        ...
        if(!agreeterms) alert('You should agree terms and conditions')
            ...
            if(newamount === 0 )  alert('Amount to deposit should not be zero')
                ...
                receipt.push({date: today,action: "You've deposited "+newamount+" RW your from your check  to your bank account"})
                ...
                <div className="dashboard">
                    ...
                    <div class="bg-white rounded-sm shadow mx-8 p-8 main-content">
                        ...
                        <section className="mt-8">
                            ...
                            <label> Upload your check: </label> <br />
                            <input className="border-none" type="file" id="file" name="avatar" accept="image/png, image/jpeg" /> <br />
